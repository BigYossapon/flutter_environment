...
//ขั้นตอนแรก สร้างไฟล์ .env.profile,.env.development,.env.production ใส่ตัวแปลที่จะเปลี่ยนทุก env ex. API_URL=https://product.com/todos/
//สร้าง ไฟล์ environtment ตาม ex
//เพื่ม path .env ทุกไฟล์ใน pubyaml in asset และ .gitignore
// เพิ่ม await dotenv.load(
